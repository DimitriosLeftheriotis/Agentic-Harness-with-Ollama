...
def extract_tool_call(response_text: str):                                                                                                                                                                                            
    ...
    try:                                                                                                                                                                                                                              
        ...
        print(f"⚠️ [Parser Warning]: Could not parse JSON from tool call: {raw_json}")                                                                                                                                                
        return None                                                                                                                                                                                                                   
